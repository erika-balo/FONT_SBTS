 ...
 exportCsv(item:any, params:any) {
		...
		function parseDate (isodate) {
         ...
         const data = {
			...
			{text: `Yo Sr(a):_____________________________________ he comprado al contado en venta pública al ser el mejor postor, el lote ${numerolote}, ${nombrelote} por la cantidad de ${final}, monto que debo y pagaré de manera inmediata a la Unión Ganadera Regional de Chihuahua el dia ${fechaPuja} en sus instalaciones, de retrasarse el pago se aplicará un interés del 10% mensual hasta su liquidación total.`, style:['padding']},
			...
			{text: `Teléfonos: 6142883705 o 6144340110`},
			{text: `Mail: ugrch.subasta@gmail.com`},
